...
public class WrapperRun {
	...
	public static void main(String[] args) {
		...
		// 기본자료형을 객체로 취급 해야 하는 경우
		// 메서드의 매개변수로 기본자료형이 아닌 객체타입만 요구 될때
		// 메서드 호출 시
		// 다형성을  적용시키고 싶을 때
		...
		// 만약에 num1 과 num2를 동등비교 하고 싶다면?
		System.out.println(num1 == num2); // 동등비교 연산자 이용
		...
		// => Wrapper클래스로 변환하여 사용
		// 기본자료형 => Wrapper 클래스 자료형(Auto Boxing)
		Integer i1 = num1;
		Integer i2 = num2;
		...
		// [표현법]
		// 해당Wrapper클래스이름.parseXXX(반환할문자열);
