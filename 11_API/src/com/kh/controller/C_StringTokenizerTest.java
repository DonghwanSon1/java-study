...
public class C_StringTokenizerTest {
	...
	// 1. 구분자를 제시해서 해당 문자열을 분리시크는 방법 => 배열이용
	// 2. 분리된 각각의 문자열을 토큰으로 취급하는 방법 => 토큰이용
	
	String str = "포켓몬빵, 룰루룰루, 낼모레시험, Java";
	...
	public void method2() {
		...
		// countTokens() 분리된 문자열의 갯수를 반환해주는 메서드
		
		// 그러면 실제로 분리된 내용물을 보고싶다면??
