...
public class Run {
	...
	/*
	 * 객체지향 프로그램 : 현실세계에서 독립적인 존재들(객체)간의 상호작용 (행위)을
	 * 				프로그래밍 언어를 통해 코드로 구현하는것!
	 * 
	 ...
	 * 							클래스는 어떻게 만드는가?							
	 * 
	 * 클래스 : 객체들의 정보를 담아내는 그릇(틀)과도 같은 존재 => VO(Value Object)
	 * 
	 * 	
	 */
		...
		Lizard L1 = new Lizard(); // 객체를 생성 => new 키워드를 사용했다!! -> 메모리의 heap영역의 공간에 할당됐다.
		Lizard L2 = new Lizard(); // 메모리의 heap영역의 공간에 할당됐다.
		...
		System.out.println(L1.name + "이의 눈 색깔은 " + L1.eyesColor
		...
		System.out.println(L2.name + "이의 눈 색깔은 " + L2.eyesColor
		...
		// 객체 지향의 설계 원칙 중 하나가 정보 은닉! => 정보은닉을 하기 위한 기술 중 하나 -> 캡슐화(encapsultion)
